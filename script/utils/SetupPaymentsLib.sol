...
library SetupPaymentsLib {
    ...
    function readOperatorConfig(
        ...
        config.operatorAddr = json.readAddressArray(".operator_addresses");
    ...
    function createOperatorDirectedAvsRewardsSubmissions(
        ...
        NewtonProverServiceManager(avs)
            .createOperatorDirectedAVSRewardsSubmission(operatorDirectedRewardsSubmissions);
    }
    ...
    function processClaim(
        ...
        IRewardsCoordinator.TokenTreeMerkleLeaf[] memory tokenLeaves =
            new IRewardsCoordinator.TokenTreeMerkleLeaf[](numTokenEarnings);
        tokenLeaves[0] = defaultTokenLeaf(100, strategy);

        // Safely cast indexToProve to uint32 with overflow check
