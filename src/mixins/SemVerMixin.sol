...
abstract contract SemVerMixin is ISemVerMixin {
    ...
    /// @param _version The SemVer-formatted version string (e.g., "1.0.0")
    ...
    /// @dev Supports single digit major versions (e.g., "1" for version "1.0.0")
    /// @return The major version string (e.g., "1" for version "1.0.0")
